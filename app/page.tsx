      ...
      <nav className="sticky top-0 z-50 bg-white/80 backdrop-blur border-b">
        <div className="max-w-7xl mx-auto px-5 md:px-8 py-5 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4 md:gap-6">
            <Link
              href="/templates"
              className="text-sm md:text-base font-medium hover:text-gray-600 transition"
            >
              Templates
            </Link>
      ...
      <section className="max-w-7xl mx-auto px-5 md:px-8 py-16 md:py-24 grid lg:grid-cols-2 gap-16 items-center">
        ...
        <div>
          ...
          <p className="text-lg md:text-xl text-gray-600 leading-8 md:leading-9 mb-10">
            Create beautiful resumes with modern templates, photo upload,
            custom sections and instant PDF export.
          </p>
          ...
          <p className="mt-8 text-gray-500 text-sm md:text-base">
            ✓ ATS Optimized &nbsp; • &nbsp; ✓ Instant PDF Export &nbsp; •
            &nbsp; ✓ 20+ Templates
          </p>
          ...
          <div className="grid grid-cols-3 gap-4 md:gap-6 mt-16">
            <div className="bg-white rounded-3xl p-5 md:p-6 shadow-lg">
              <h3 className="text-3xl md:text-4xl font-black">20+</h3>
            ...
            <div className="bg-white rounded-3xl p-5 md:p-6 shadow-lg">
              <h3 className="text-3xl md:text-4xl font-black">PDF</h3>
              <p className="text-gray-600 mt-2 text-sm md:text-base">
                Export
              </p>
            </div>
            ...
            <div className="bg-white rounded-3xl p-5 md:p-6 shadow-lg">
              <h3 className="text-3xl md:text-4xl font-black">ATS</h3>
              <p className="text-gray-600 mt-2 text-sm md:text-base">
                Optimized
              </p>
            </div>
